...
public class CameraActivity extends AppCompatActivity {
    ...
    private static CameraActivity me; // CameraView에서 Activity.finish()로 액티비티를 종료시키기 위한 변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        me = this;
        mCameraFacing  = 1; // 최초 카메라 상태는 후면카메라로 설정
    ...
    private void init() {
        ...
        addContentView(LayoutInflater.from( me ).inflate( R.layout.activity_camera, null),
